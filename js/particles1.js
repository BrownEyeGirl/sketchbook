...
function setup() {
  ...
  */
  ...
  nextTriggerTime = 1; // how often beat is triggered 
    ...
    particleSpeedSlider.addClass("particle-threshold-slider"); 
    container2 = createDiv(); 
    container2.addClass("slider-container2");
    
    label2 = createSpan("Particle Speed: "); 
    label2.addClass("slider-label2");
   ...
   container1.addClass("slider-container1");
    ...
    label1 = createSpan("Bass Ssensitivity: ");
